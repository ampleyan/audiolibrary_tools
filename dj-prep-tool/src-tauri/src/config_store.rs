...
pub struct PublicSettings {
    ...
    pub beets_path: String,
    pub music_library_dir: String,
    pub beets_config_dir: String,
...
pub fn get_public(app: &AppHandle) -> PublicSettings {
    PublicSettings {
        ...
        beets_path: get(app, "beets_path").unwrap_or_default(),
        music_library_dir: get(app, "music_library_dir").unwrap_or_default(),
        beets_config_dir: get(app, "beets_config_dir").unwrap_or_default(),
        ffmpeg_path: get(app, "ffmpeg_path").unwrap_or_default(),
        rekordbox_import_dir: get(app, "rekordbox_import_dir").unwrap_or_default(),
        rekordbox_xml_path: get(app, "rekordbox_xml_path").unwrap_or_default(),
